    ...
    <>
      ...
      {success ? (
        <section style={{backgroundColor:'#2f2f33'}}>
          ...
          <h1 className='fontLog' style={{color:'#f0f0f7'}}>
            We have sent you an email to the address you provided for account
            verification. Please verify your account in order to log in.
          </h1>
